<template>
  <div class="wrap">
    ...
    <main>
      ...
      <div class="total">
        {{allTransactionTotal}} transactions found
      </div>
      <nav>
        <div class="nav-item-wrap">
          <span v-for="item in tips" class="normal" :class="{'choice':item.show}"
      ...
      <other v-else-if="tips[7].show" :tableData="tableData"></other>
      <el-pagination
        class="pagination"
